                    ...
                    <div className="flex flex-wrap -m-4">
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                <img alt="testimonial" className="w-20 h-20 mb-8 object-cover object-center rounded-full inline-block border-2 border-gray-200 bg-gray-100" src="https://media.licdn.com/dms/image/D4D03AQElJTWq0z1csA/profile-displayphoto-shrink_800_800/0/1674316495425?e=1708560000&v=beta&t=9o37Wy_5iwXVodtnNR-E9AAAlSNGByVetnZlXSq9Hj4" />
                                ...
                                <h2 style={{color: mode === 'dark' ? '#ff4162' : ''}} className="text-gray-900 font-medium title-font tracking-wider text-sm uppercase">Pushpendra Chaudhary</h2>
                                <p style={{color: mode === 'dark' ? 'white' : ''}} className="text-gray-500">Junior Product Designer</p>
                            </div>
                        </div>
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
